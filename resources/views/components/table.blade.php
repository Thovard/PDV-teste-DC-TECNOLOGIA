...
<style>
    ...
    .card-header { background: #343a40; color: white; }
    .pagination-container { display: flex; justify-content: center; margin-top: 15px; }
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            ...
            @if ($registerButtonText)
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#{{ $idRegistreModal }}">
...
$(document).ready(function() {
    let rows = $("#dataTable tbody tr"), perPage = 10;
    ...
    function paginateTable(filteredRows = rows) {
        ...
        if (totalPages > 1) {
            ...
            for (let i = 1; i <= totalPages; i++) {
                $("<li class='page-item'><a href='#' class='page-link'>" + i + "</a></li>").appendTo(pagination);
            }
